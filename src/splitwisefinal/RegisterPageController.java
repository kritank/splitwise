...
public class RegisterPageController implements Initializable {
    ...
    private void registerButtonClicked(MouseEvent event) {
		...
		{ 
			...
			public void run() { 
                ...
                sendMessage.start(); 
                System.out.println("Registration Details Sent to Server!!");
                // readMessage thread 
		...
		{ 
			...
			public void run() { 
                                                ...
                                                switch(result){
                                                      case 1:
                                                                ...
                                                                Platform.runLater(new Runnable() {
                                                                    public void run() {
                                                                        statusField.setText("Registered!!!");
                                                                        ...
                                                                        emailField.setPromptText("Eg: someone@something.com");
                                                                        otpField.setPromptText("SPLTWS979799");
                                                                        phoneNoField.setPromptText("Eg: 9323233232");
                                                                    }
                                                                });
                                                                
                                                                break;
                                                      case 0:
                                                                statusFieldAlert salert=new statusFieldAlert(statusField,"Unable to Register!!");
                                                                 salert.alert();
                                                                break;
                                                      default:  
                ...
                System.out.println("Got the message from server");
                    ...
                    System.out.println("Outer: Problem in seding: Registration details!"+ex); 
                }

        }
      }else{
            statusField.setText("Already Registered!!");
        }
    ...
    private void resetButtonClicked(MouseEvent event) {
        ...
        emailField.setPromptText("Eg: someone@something.com");
        otpField.setPromptText("SPLTWS979799");
        phoneNoField.setPromptText("Eg: 97979797");
    }
    ...
    void setPhoneNoValidityChecker()
    {
      ...
      InetAddress ip = InetAddress.getByName("localhost"); 
        ...
        }catch(Exception ex)
        {
            ...
            if(phoneNoField.getText().equals(lastPhoneNo))
            {
